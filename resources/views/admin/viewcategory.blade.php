...
<table style="width: 100%; border-collapse: collapse; font-family: Arial, sans-serif;">
    <thead>
        <tr style="background-color: #f2f2f2">
            <th style="padding:12px; text-align: left; border-bottom: 1px soid #ddd;">Category ID</th>
            <th style="padding:12px; text-align: left; border-bottom: 1px soid #ddd;">Category Name</th>
    ...
    <tbody>
        ...
        <tr style="border-bottom: 1px solid #ddd;">
            ...
            <td style="padding: 12px;"><a href="" style="color:green;">Update1</a></td>
