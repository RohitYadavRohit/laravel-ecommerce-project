...
<table style="width: 100%; border-collapse: collapse; font-family: Arial, sans-serif;">
    <thead>
        <tr style="background-color: #f2f2f2">
            ...
            <th style="padding:12px; text-align: left; border-bottom: 1px soid #ddd;">Product Descriptions</th>
            <th style="padding:12px; text-align: left; border-bottom: 1px soid #ddd;">Product Quantity</th>
            ...
            <th style="padding:12px; text-align: left; border-bottom: 1px soid #ddd;">Product Category</th>
    ...
    <tbody>
        ...
        <tr style="border-bottom: 1px solid #ddd;">
            ...
            <td style="padding: 12px;">{{Str::limit($product->product_description,30)}}</td>
